...
type TunnelOpenReq struct {
	...
	Type          TunnelType             `protobuf:"varint,1,opt,name=type,proto3,enum=nexus.pkg.TunnelType" json:"type,omitempty"`    // 隧道类型
	RemoteAddr    string                 `protobuf:"bytes,2,opt,name=remote_addr,json=remoteAddr,proto3" json:"remote_addr,omitempty"` // 隧道目标地址
...
func (x *TunnelOpenReq) GetType() TunnelType {
	if x != nil {
		return x.Type
	}
...
func (x *TunnelOpenReq) GetRemoteAddr() string {
	if x != nil {
		return x.RemoteAddr
	}
	return ""
...
type TunnelOpenResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TunnelOpenResp) Reset() {
	*x = TunnelOpenResp{}
...
func (x *TunnelOpenResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TunnelOpenResp) ProtoMessage() {}

func (x *TunnelOpenResp) ProtoReflect() protoreflect.Message {
	mi := &file_tunnel_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TunnelOpenResp.ProtoReflect.Descriptor instead.
func (*TunnelOpenResp) Descriptor() ([]byte, []int) {
...
const file_tunnel_proto_rawDesc = "" +
	"\n" +
	"\ftunnel.proto\x12\tnexus.pkg\x1a\fcommon.proto\"[\n" +
	"\rTunnelOpenReq\x12)\n" +
	"\x04type\x18\x01 \x01(\x0e2\x15.nexus.pkg.TunnelTypeR\x04type\x12\x1f\n" +
	"\vremote_addr\x18\x02 \x01(\tR\n" +
	"remoteAddr\"\x10\n" +
	"\x0eTunnelOpenRespB)Z'github.com/Tudyha/nexus/pkg/proto/protob\x06proto3"
...
var file_tunnel_proto_goTypes = []any{
	(*TunnelOpenReq)(nil),  // 0: nexus.pkg.TunnelOpenReq
	(*TunnelOpenResp)(nil), // 1: nexus.pkg.TunnelOpenResp
	(TunnelType)(0),        // 2: nexus.pkg.TunnelType
}
var file_tunnel_proto_depIdxs = []int32{
	2, // 0: nexus.pkg.TunnelOpenReq.type:type_name -> nexus.pkg.TunnelType
