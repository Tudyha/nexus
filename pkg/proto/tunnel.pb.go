...
func (x *TunnelOpenAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TunnelOpenAck) ProtoMessage() {}

func (x *TunnelOpenAck) ProtoReflect() protoreflect.Message {
	mi := &file_tunnel_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TunnelOpenAck.ProtoReflect.Descriptor instead.
func (*TunnelOpenAck) Descriptor() ([]byte, []int) {
...
const file_tunnel_proto_rawDesc = "" +
	...
	"remoteAddr\"\x0f\n" +
	"\rTunnelOpenAckB)Z'github.com/Tudyha/nexus/pkg/proto/protob\x06proto3"
...
var file_tunnel_proto_goTypes = []any{
	...
	(*TunnelOpenAck)(nil), // 1: nexus.pkg.TunnelOpenAck
