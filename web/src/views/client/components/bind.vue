...
import { clientOsIconMap } from '@/map'
...
<template>
    <div class="tabs tabs-lift">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <span class="text-sm font-medium flex items-center gap-2">
                        <Icon :icon="clientOsIconMap[1]" class="w-5 h-5 text-blue-500" />
                        Windows 绑定命令
                    </span>
        ...
        <input type="radio" name="bind_tabs" class="tab" :aria-label="'Linux'" checked />
        <div class="tab-content bg-base-100 border-base-300 rounded-box p-6">
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <span class="text-sm font-medium flex items-center gap-2">
                        <Icon :icon="clientOsIconMap[2]" class="w-5 h-5 text-base-content" />
                        Linux 绑定命令
                    </span>
                    <CopyButton class="btn-xs" :text="data?.mac_bind" />
                </div>
                <div class="mockup-code">
                    <pre class="overflow-x-auto"><code class="text-xs">{{ data?.linux_bind }}</code></pre>
                </div>
            </div>
        </div>

        <input type="radio" name="bind_tabs" class="tab" :aria-label="'macOS'" />
        <div class="tab-content bg-base-100 border-base-300 rounded-box p-6">
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <span class="text-sm font-medium flex items-center gap-2">
